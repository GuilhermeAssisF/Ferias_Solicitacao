            ...
            htmlDialog += '<div class="modal-dialog">';
                htmlDialog += '<div class="modal-content" style="width:' + this.Width + 'px;">';
                    ...
                    htmlDialog += '<div class="modal-body" style="overflow:auto; height:300px; padding:0px; padding-right:0px;">';
                        ...
                        htmlDialog += '<div id="' + this.Id + '_dataTable_carregando"><h3 align="center"><img src="https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExaXB5NDY1b2NyeWFrM3M1YWh5eWhhOHJqdzd6eXljbGZwd3JiMWdydCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/KG4PMQ0jyimywxNt8i/giphy.gif" width="120" height="120">&nbsp;Aguarde... <br><br>processando as informações solicitadas :)</h3></div>';
                    htmlDialog += '</div>';
                    // FIM do Body
